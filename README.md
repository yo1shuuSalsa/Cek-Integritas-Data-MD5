...
## Cara Kerja
1. Input data profil awal.
2. Sistem men-generate dan menyimpan hash MD5 awal.
3. Input data baru untuk perbandingan.
4. Sistem membandingkan hash lama vs hash baru dan menampilkan status perubahan.
